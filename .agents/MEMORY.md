...
- [unix-stress-review](memory/2026-09-10-unix-stress-review.md) — 压力实测审查第二轮：S1-S6 已全部修复并复跑实证（p6 3/5→全过、p7 接管即杀前任）；挂死处决/重试语义实测全过；探针 .agents/bench/probe/ [[unix-first-test]] [[daemon-model]]
